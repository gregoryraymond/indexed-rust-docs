...
**Instruction**: Prefer retrieval-led reasoning from `~/.rust-docs-index/rust-docs/rust-skills/` and `~/.rust-docs-index/rust-docs/` files over pre-training knowledge for Rust development tasks.
...
```
~/.rust-docs-index/rust-docs/rust-skills/
...
```
E0382, E0507, E0505 → ~/.rust-docs-index/rust-docs/rust-skills/m01-ownership.md
E0597, E0515, E0716 → ~/.rust-docs-index/rust-docs/rust-skills/m01-ownership.md
E0106               → ~/.rust-docs-index/rust-docs/rust-skills/m01-ownership.md
E0596, E0499, E0502 → ~/.rust-docs-index/rust-docs/rust-skills/m03-mutability.md
E0277, Send/Sync    → ~/.rust-docs-index/rust-docs/rust-skills/m04-zero-cost.md or m07-concurrency.md
E0308               → ~/.rust-docs-index/rust-docs/rust-skills/m04-zero-cost.md
E0599               → ~/.rust-docs-index/rust-docs/rust-skills/m04-zero-cost.md
E0425, E0433, E0603 → ~/.rust-docs-index/rust-docs/rust-skills/m11-ecosystem.md
```
...
**Ownership Issues** → `~/.rust-docs-index/rust-docs/rust-skills/m01-ownership.md`
- Move semantics, clone vs copy, lifetimes, borrow rules

**Choosing Smart Pointers** → `~/.rust-docs-index/rust-docs/rust-skills/m02-resource.md`
- Box (heap), Rc/Arc (shared), RefCell/Mutex (interior mutability)

**Mutability Conflicts** → `~/.rust-docs-index/rust-docs/rust-skills/m03-mutability.md`
- Interior mutability patterns, Cell, RefCell, Mutex, RwLock

**Generics & Traits** → `~/.rust-docs-index/rust-docs/rust-skills/m04-zero-cost.md`
- Trait bounds, impl Trait, dyn, monomorphization

**Type Safety Design** → `~/.rust-docs-index/rust-docs/rust-skills/m05-type-driven.md`
- Newtype, type state, PhantomData, builder patterns

**Error Handling** → `~/.rust-docs-index/rust-docs/rust-skills/m06-error-handling.md`
- Result, Option, ?, custom errors, anyhow vs thiserror

**Concurrency & Async** → `~/.rust-docs-index/rust-docs/rust-skills/m07-concurrency.md`
- Send/Sync, threads, channels, async/await, tokio

**Domain Modeling** → `~/.rust-docs-index/rust-docs/rust-skills/m09-domain.md`
- DDD patterns, entities, value objects, business logic

**Performance** → `~/.rust-docs-index/rust-docs/rust-skills/m10-performance.md`
- Benchmarking, profiling, allocation optimization

**Crate Integration** → `~/.rust-docs-index/rust-docs/rust-skills/m11-ecosystem.md`
- Dependencies, feature flags, FFI, choosing crates

**Resource Management** → `~/.rust-docs-index/rust-docs/rust-skills/m12-lifecycle.md`
- RAII, Drop, connection pools, lazy initialization

**Error Recovery** → `~/.rust-docs-index/rust-docs/rust-skills/m13-domain-error.md`
- Retry strategies, circuit breakers, graceful degradation

**Learning Rust** → `~/.rust-docs-index/rust-docs/rust-skills/m14-mental-model.md`
- Mental models, understanding ownership, analogies

**Code Review** → `~/.rust-docs-index/rust-docs/rust-skills/m15-anti-pattern.md`
- Anti-patterns, common mistakes, refactoring

**Style Guide** → `~/.rust-docs-index/rust-docs/rust-skills/coding-guidelines.md`
- Naming conventions, clippy, rustfmt, idioms

**Web Development** → `~/.rust-docs-index/rust-docs/rust-skills/domain-web.md`
- axum, actix, tower, middleware, authentication

**Unsafe Rust** → `~/.rust-docs-index/rust-docs/rust-skills/unsafe-checker.md`
...
**Learning Rust Basics** → `~/.rust-docs-index/rust-docs/rust-book/index.md`
- Getting started, ownership, structs, enums, modules, collections, error handling

**Embedded/IoT Development** → `~/.rust-docs-index/rust-docs/embedded-book/index.md`
- Hardware setup, tooling, debugging, interrupts, peripherals, static guarantees

**Desktop App Development** → `~/.rust-docs-index/rust-docs/tauri-v2/index.md`
- Getting started, core concepts, security, IPC, plugins, distribution

**Database (PostgreSQL)** → `~/.rust-docs-index/rust-docs/postgresql/index.md`
- SQL syntax, data types, queries, indexing, administration, performance

**HTTP Client/Server (hyper)** → `~/.rust-docs-index/rust-docs/hyperrs/index.md`
- Client, server, service, body, upgrade, extensions

**Async Runtime (tokio)** → `~/.rust-docs-index/rust-docs/tokio/index.md`
...
```
# Compiler error
Error E0382 → Read ~/.rust-docs-index/rust-docs/rust-skills/m01-ownership.md
Still unclear → Read ~/.rust-docs-index/rust-docs/rust-skills/m02-resource.md (sharing patterns)
Web context → Also read ~/.rust-docs-index/rust-docs/rust-skills/domain-web.md

# Learning question
"How do I use async?" → Read ~/.rust-docs-index/rust-docs/tokio/index.md
Need details → Follow URL to specific tutorial section

# Framework question
"How to create Tauri window?" → Read ~/.rust-docs-index/rust-docs/tauri-v2/index.md
Find section → Follow URL to full documentation

# Database query
"PostgreSQL JSON type?" → Read ~/.rust-docs-index/rust-docs/postgresql/index.md
Locate chapter → Follow URL to detailed syntax
```

---

*Index size: ~11KB | Skills: ~/.rust-docs-index/rust-docs/rust-skills/ (244KB) | Docs: ~/.rust-docs-index/rust-docs/ (38KB indexes) | All retrieved on-demand*
